...
| **10** | **Parry Block Quick Attack Finisher System** | nemy attack telegraphs · Directional block validation · Timed parry windows · One-hit-per-swing guard · Interrupt/ownership rules · GAS tag/effect gating · Animation-driven block/parry windows · Parry reward branching · Quick Attack punish · Finisher eligibility + execution · Combat state cleanup · High-enemy-count safe hit handling | [🔗 Repo](https://github.com/Mustafa-Kum/ue5-rpg-parry-block-finisher-quickattack-system) |
| **11** | **Dismemberment & Blood Feedback System** | Profile-driven dismemberment zones · Bone/child-bone hit resolution · Hit-location fallback · Source-body bone hiding · Detached severed limb actors · Stump visuals · Cut blood VFX · Combat blood feedback · Separate VFX budgets · Pooled severed limbs · Death-flow ownership · Cleanup for pooled enemies and dissolving corpses | [🔗 Repo](https://github.com/Mustafa-Kum/ue5-dismamber-blood-system) |
| **12** | **Weapon Throw & Recall System** | Aim → throw → stick → recall → catch lifecycle · Dedicated throw state machine · Camera-trace aim resolution · Animation-notify release frame · Projectile flight + tumble spin · Stick-into-target behavior · Boomerang recall curve · Combat-owned thrown damage/blood · Dismemberment-aware dislodge · Equipment/inventory integration · One-slot projectile pooling · Token-guarded async montage loading | [🔗 Repo](https://github.com/Mustafa-Kum/ue5-weaponthrow-system) |
